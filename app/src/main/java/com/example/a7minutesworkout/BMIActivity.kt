...
class BMIActivity : AppCompatActivity() {
    ...
    companion object {
        private const val METRIC_UNITS_VIEW = "MRETIC_UNIT_VIEW"
        private const val US_MRETIC_VIEW = "US_UNIT_VIEW"
    }
    ...
    private fun makeVisibleUsUnitsView() {
        currentVisibleView = US_MRETIC_VIEW
        ...
        binding.etUsMetricUsUnitHeightInch.text!!.clear()
        ...
        if (currentVisibleView == METRIC_UNITS_VIEW) {
            ...
            if (validateUsMetricUnits()) {
                ...
                val usUnitHeightValueInch: String =
                    binding.etUsMetricUsUnitHeightInch.text.toString()
                ...
                val bmi = 703 * (usUnitWeightValue / (heightVlaue * heightVlaue))
    ...
    private fun validateUsMetricUnits(): Boolean {
        ...
        when {
            ...
            binding.etUsMetricUsUnitHeightInch.text.toString().isEmpty() -> {
                isValid = false
            }
        }
